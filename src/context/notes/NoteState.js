  ...
  const getNotes = async () => {
    ...
    const response = await fetch(`${host}/api/notes/fetchallnotes`, {
      ...
      headers: {
        ...
        'auth-token':'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiNjNkNGY3NzU1Y2M2ZWZhNzc0ZGIyODJkIn0sImlhdCI6MTY3NDkwMTM2NX0.D_k_NVmjkPDF_Iv3hKx9t0Gbd2muuIQisJgf2jdwBCA'
      }
    });
